            ...
            <div class="container-fluid">
                <table class="table_design">
                    ...
                    <tr class="tr_design">
                        ...
                        <td class="td_design">
                            <img width="100" src="/uploads/rooms/{{$item->image}} " alt="" />
                        </td>
                        <td class="td_design">{{$item->created_at}}</td>
                        <td class="td_design">
                            <a onclick="return confirm('are you sure to Update this?')" class="btn btn-warning" href="{{url('room_update',$item->id)}}">Update</a>
                        </td>
                        <td class="td_design">
